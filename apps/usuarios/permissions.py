...
class IsEmpresa(IsEmpresaUser):
    """Alias compatible para IsEmpresaUser (administración de catálogo / tiendas)."""
...
class IsCliente(IsClienteUser):
    """Alias compatible para IsClienteUser."""
    pass
